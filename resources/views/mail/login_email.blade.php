...
<h1><span class="blue"><span class="yellow">CRAutos</span></h1>
    <h2>¡Hola {{$usuario['nombre']}}, esta es tu nueva cuenta!</h2>
    ...
    <table class="container">
        ...
        <tbody>
            ...
            <tr>
                <td>Correo</td>
                <td style="color: white"> {{ $usuario['correo'] }}</td>
            </tr>
            <tr>
                <td>Acceso</td>
                <td > <a href="http://localhost:8000/" style="color:white;">CRAutos.com</a></td>
            </tr>
